...
const schema = new mongoose.Schema({
  ...
  specialization: {
    type: String,
    trim: true,
    enum: ['Industrial Electrical', 'Control Systems', 'Motor Repair', 'Wiring', 'Instrumentation', 'Other'],
    default: 'Industrial Electrical',
  },
  certifications: [{
    type: String,
    trim: true,
...
const Electrician = mongoose.model('Electrician', schema);
