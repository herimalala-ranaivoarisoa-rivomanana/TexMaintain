...
import { getEquipmentTypes, createEquipmentType, updateEquipmentType, deleteEquipmentType, getEquipmentTypeStats } from "@/api/equipmentTypes"
import { getEquipmentCategories } from "@/api/equipmentCategories"
// import { getEquipment } from "@/api/equipment" // Removed
...
export function EquipmentTypes() {
  ...
  const fetchData = async () => {
    try {
      ...
      setStats(statsResponse.stats || []) // Use server-side stats directly
  ...
  // calculateEquipmentStats removed
