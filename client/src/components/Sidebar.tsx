      ...
      <div className="flex items-center justify-between p-4 border-b border-slate-200/60 dark:border-slate-700/60">
        {!collapsed && (
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent truncate max-w-[160px]" title={currentFactory?.name}>
              {currentFactory?.name || 'TexMaintain'}
            </span>
          </div>
        )}
        <Button
